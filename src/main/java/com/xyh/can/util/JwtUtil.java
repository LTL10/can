...
//       log.warn("测试生成一个token\n"+sign);
       boolean a = verify("eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjE1NzUyODU5MDgsInVzZXJuYW1lIjoiYWRtaW4ifQ.XRJsWXaxyJiOPGphFaPswuv1Ibud0apxOjGvXdpHHG8","admin","123456");
